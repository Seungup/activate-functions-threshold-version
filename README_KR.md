...
음의 범위에 있는 ReLU의 기울기도 0이기 때문에, 일단 뉴런이 음이 되면, 회복될 가능성은 낮습니다. 
그러한 뉴런들은 입력을 구별하는데 아무런 역할을 하지 않으며 본질적으로 쓸모없습니다. 
학습 속도가 낮아지면 문제가 완화되는 경우가 많습니다. 
그렇지 않은 경우 누출이 있는 Leaky ReLU 및 ELU도 시도해 볼 수 있는 좋은 대안입니다. 
